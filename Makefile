VERVE_VERSION := $(shell cat VERVE_VERSION)
VERVE_DEPS := $(wildcard VERVE_*) fix_output
DOCKER_TAG_PREFIX := rzuckerm/verve:$(VERVE_VERSION)
...
$(META_BUILD_TARGET): Dockerfile Makefile $(VERVE_DEPS)
